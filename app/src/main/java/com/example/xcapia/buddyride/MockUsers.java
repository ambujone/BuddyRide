...
public class MockUsers {
    ...
    public MockUsers() {
        ...
        this.userlist.add(new MockUser(1,"Rene Birkeland","123456789","http://i.imgur.com/18Ez95B.jpg", 4, "12 min"));
        ...
        this.userlist.add(new MockUser(6,"Ivan Tan","123456789","http://i.imgur.com/WL5QA4e.jpg", 3, "31 min"));
        this.userlist.add(new MockUser(7,"Ben Steer","123456789","http://i.imgur.com/WL5QA4e.jpg", 5,"42 min"));
        this.userlist.add(new MockUser(8,"Ben Steer","123456789","http://i.imgur.com/WL5QA4e.jpg", 4,"49 min"));
